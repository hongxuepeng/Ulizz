  ...
  var render = {
    ...
    initList: function initList() {
      ...
      forEach(this.images, function (image, i) {
        ...
        if (src || url) {
          items.push('<li>' + '<img data-src="'+dataSrc+'" +' + (' src="' + (src || url) + '"') + ' role="button"' + ' data-action="view"' + (' data-index="' + i + '"') + (' data-original-url="' + (url || src) + '"') + (' alt="' + alt + '"') + '>' + '</li>');
        }
      });
  ...
  var methods = {
    ...
    view: function view() {
      ...
      if(alt=="1"){
          ...
          image.setAttribute('preload','none');
